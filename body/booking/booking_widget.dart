...
class BookingWidget extends StatefulWidget {
  const BookingWidget({super.key, this.addModelFn});
...
class _BookingWidgetState extends State<BookingWidget> with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final bookingTrainerProfileResponse = snapshot.data!;
        _model.debugBackendQueries[
                'TrainerProfileCall_statusCode_Scaffold_w169hqfy'] =
            debugSerializeParam(
          bookingTrainerProfileResponse.statusCode,
          ParamType.int,
          link:
        ...
        _model.debugBackendQueries[
                'TrainerProfileCall_responseBody_Scaffold_w169hqfy'] =
            debugSerializeParam(
          bookingTrainerProfileResponse.bodyText,
          ParamType.String,
          link:
              'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=Booking',
          name: 'String',
                                ...
                                child: Align(
                                  ...
                                  child: Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        5.0, 0.0, 0.0, 0.0),
                                    child: Text(
                                      'Запись к тренеру ${TrainerProfileSchemaStruct.maybeFromMap(bookingTrainerProfileResponse.jsonBody)?.name}',
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              _model.apiResult5a7 =
                                ...
                                time: dateTimeFormat("Hm", _model.datePicked2),
                              );
