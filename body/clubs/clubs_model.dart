  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'listofsearch': debugSerializeParam(
            ...
            searchReference:
                'reference=Qh0KFQoMbGlzdG9mc2VhcmNoEgVrdHM0dHIECAUgAVABWgxsaXN0b2ZzZWFyY2hiBUNsdWJz',
            name: 'bool',
            nullable: false,
          ),
          'namecoach': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=Clubs',
            searchReference:
                'reference=QhwKEgoJbmFtZWNvYWNoEgVhOWN1OXIGEgIIAyABUAFaCW5hbWVjb2FjaGIFQ2x1YnM=',
            name: 'String',
            nullable: false,
          ),
          'descriptioncoach': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=Clubs',
            searchReference:
                'reference=QicKGQoQZGVzY3JpcHRpb25jb2FjaBIFb2V1ZXMqAhIAcgYSAggDIAFQAVoQZGVzY3JpcHRpb25jb2FjaGIFQ2x1YnM=',
            name: 'String',
            nullable: false,
          ),
          'sorting': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=Clubs',
            searchReference:
                'reference=QhgKEAoHc29ydGluZxIFajdjaHNyBAgFIAFQAVoHc29ydGluZ2IFQ2x1YnM=',
            name: 'bool',
            nullable: false,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq/tab=uiBuilder&page=Clubs',
        searchReference: 'reference=OgVDbHVic1ABWgVDbHVicw==',
        widgetClassName: 'Clubs',
      );
}
