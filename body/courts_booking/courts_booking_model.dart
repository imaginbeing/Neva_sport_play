...
import 'courts_booking_widget.dart' show CourtsBookingWidget;
...
class CourtsBookingModel extends FlutterFlowModel<CourtsBookingWidget> {
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'date1': debugSerializeParam(
            ...
            searchReference:
                'reference=QhoKDgoFZGF0ZTESBTBpc3Z2KgISAHIECAMgAFABWgVkYXRlMWINQ291cnRzQm9va2luZw==',
            name: 'String',
            nullable: true,
          ),
          'yellow1': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=CourtsBooking',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MRIFYm1ocHgqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93MWINQ291cnRzQm9va2luZw==',
            name: 'bool',
            nullable: false,
          ),
          'yellow2': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=CourtsBooking',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MhIFN2JvZWYqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93MmINQ291cnRzQm9va2luZw==',
            name: 'bool',
            nullable: false,
          ),
          'yellow3': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=CourtsBooking',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MxIFZ3FxZHYqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93M2INQ291cnRzQm9va2luZw==',
            name: 'bool',
            nullable: false,
          ),
          'yellow4': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=CourtsBooking',
            searchReference:
                'reference=QiEKEAoHeWVsbG93NBIFbXlsNWwqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93NGINQ291cnRzQm9va2luZw==',
            name: 'bool',
            nullable: false,
          )
        },
        ...
        link:
            'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq/tab=uiBuilder&page=CourtsBooking',
        searchReference:
            'reference=Og1Db3VydHNCb29raW5nUAFaDUNvdXJ0c0Jvb2tpbmc=',
        widgetClassName: 'CourtsBooking',
      );
}
