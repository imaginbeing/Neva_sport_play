  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'visiblegallery': debugSerializeParam(
            ...
            searchReference:
                'reference=QigKFwoOdmlzaWJsZWdhbGxlcnkSBWphcDJsKgcSBWZhbHNlcgQIBSABUAFaDnZpc2libGVnYWxsZXJ5YglFdmVudFBhZ2U=',
            name: 'bool',
            nullable: false,
          ),
          'visibleava': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=EventPage',
            searchReference:
                'reference=QiQKEwoKdmlzaWJsZWF2YRIFNmJ3b3oqBxIFZmFsc2VyBAgFIAFQAVoKdmlzaWJsZWF2YWIJRXZlbnRQYWdl',
            name: 'bool',
            nullable: false,
          ),
          'selectedpage': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=EventPage',
            searchReference:
                'reference=Qh0KFQoMc2VsZWN0ZWRwYWdlEgU1d2x0a3IECAEgAFABWgxzZWxlY3RlZHBhZ2ViCUV2ZW50UGFnZQ==',
            name: 'int',
            nullable: true,
          )
        },
