...
class TournamentsModel extends FlutterFlowModel<TournamentsWidget> {
  ...
  // State field(s) for Dateot widget.
  FocusNode? dateotFocusNode;
  TextEditingController? dateotTextController;
  String? Function(BuildContext, String?)? dateotTextControllerValidator;
  ...
  void dispose() {
    ...
    dateotFocusNode?.dispose();
    dateotTextController?.dispose();
  ...
  WidgetClassDebugData toWidgetClassDebugData() => WidgetClassDebugData(
        localStates: {
          'date1': debugSerializeParam(
            ...
            searchReference:
                'reference=QhoKDgoFZGF0ZTESBTBpc3Z2KgISAHIECAMgAFABWgVkYXRlMWILdG91cm5hbWVudHM=',
            name: 'String',
            nullable: true,
          ),
          'yellow1': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MRIFYm1ocHgqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93MWILdG91cm5hbWVudHM=',
            name: 'bool',
            nullable: false,
          ),
          'yellow2': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MhIFN2JvZWYqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93MmILdG91cm5hbWVudHM=',
            name: 'bool',
            nullable: false,
          ),
          'yellow3': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            searchReference:
                'reference=QiEKEAoHeWVsbG93MxIFZ3FxZHYqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93M2ILdG91cm5hbWVudHM=',
            name: 'bool',
            nullable: false,
          ),
          'yellow4': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            searchReference:
                'reference=QiEKEAoHeWVsbG93NBIFbXlsNWwqBxIFZmFsc2VyBAgFIAFQAVoHeWVsbG93NGILdG91cm5hbWVudHM=',
            name: 'bool',
            nullable: false,
          ),
          'sorting': debugSerializeParam(
            ...
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            searchReference:
                'reference=QiEKEAoHc29ydGluZxIFYjNqMDQqBxIFZmFsc2VyBAgFIABQAVoHc29ydGluZ2ILdG91cm5hbWVudHM=',
            name: 'bool',
            nullable: true,
          )
        },
        widgetStates: {
          ...
          'dateotText': debugSerializeParam(
            dateotTextController?.text,
            ParamType.String,
            link:
                'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=tournaments',
            name: 'String',
        ...
        link:
            'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq/tab=uiBuilder&page=tournaments',
        searchReference: 'reference=Ogt0b3VybmFtZW50c1ABWgt0b3VybmFtZW50cw==',
        widgetClassName: 'tournaments',
      );
}
