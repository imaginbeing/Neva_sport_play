...
class ChatPageWidget extends StatefulWidget {
  ...
  final DocumentReference? recieve;
...
class _ChatPageWidgetState extends State<ChatPageWidget> with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<ChatsRecord>(
      stream: ChatsRecord.getDocument(widget!.recieve!),
      builder: (context, snapshot) {
        ...
        _model.debugBackendQueries['chatPageChatsRecord_Scaffold_mexdphsh'] =
            debugSerializeParam(
          chatPageChatsRecord,
          ParamType.Document,
          link:
                                  ...
                                  await showDialog(
                                    ...
                                    builder: (alertDialogContext) {
                                      return AlertDialog(
                                        ...
                                        content: Text('Ты дурак? Ты один тут'),
                                        actions: [
                                          TextButton(
                                            onPressed: () => Navigator.pop(
                                                alertDialogContext),
                                            child: Text('Понял босс'),
                                          ),
                                        ],
                                      );
                                    },
                        ...
                        child: StreamBuilder<List<ChatMessageRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            _model.debugBackendQueries[
                                    'listViewChatMessageRecordList_ListView_n0gpe0hr${listViewChatMessageRecordList.length > 100 ? ' (first 100)' : ''}'] =
                                debugSerializeParam(
                              listViewChatMessageRecordList.take(100),
                              ParamType.Document,
                              isList: true,
                              link:
                                  'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=ChatPage',
                            ...
                            return ListView.builder(
                              ...
                              itemBuilder: (context, listViewIndex) {
                                ...
                                return Stack(
                                  children: [
                                    if (listViewChatMessageRecord.idOfSender !=
                                        FFAppState().profiledata.id)
                                      Padding(
                                        padding: EdgeInsetsDirectional.fromSTEB(
                                            10.0, 0.0, 10.0, 10.0),
                                        ...
                                        onPressed: (_model
                                            ...
                                            : () async {
                                                await ChatMessageRecord
                                                  ...
                                                  timeStamp:
                                                      getCurrentTimestamp,
                                                  nameofSender: FFAppState()
                                                      .profiledata
                                                      .name,
                                                  idOfSender: FFAppState()
                                                      .profiledata
                                                      .id,
                                                ));
