...
class ChatsWidget extends StatefulWidget {
  const ChatsWidget({super.key, this.addModelFn});
...
class _ChatsWidgetState extends State<ChatsWidget> with RouteAware {
    ...
    return StreamBuilder<List<ChatsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        _model.debugBackendQueries[
                'chatsChatsRecordList_Scaffold_cxf8yegu${chatsChatsRecordList.length > 100 ? ' (first 100)' : ''}'] =
            debugSerializeParam(
          chatsChatsRecordList.take(100),
          ParamType.Document,
          isList: true,
          link:
                                  ...
                                  child: Align(
                                    ...
                                    child: Padding(
                                      ...
                                      child: FlutterFlowChoiceChips(
                                        options: [ChipData('Личные сообщения')],
                                          ...
                                          child: Container(
                                            ...
                                            child:
                                              ...
                                              future: TrainerProfileCall.call(
                                                ...
                                                id: functions.getOtherUserRef(
                                                    containerVarItem.usersId
                                                        .toList(),
                                                    FFAppState()
                                                        .profiledata
                                                        .id),
                                              ...
                                              builder: (context, snapshot) {
                                                ...
                                                final rowTrainerProfileResponse =
                                                    snapshot.data!;
                                                _model.debugBackendQueries[
                                                        'TrainerProfileCall_statusCode_Row_gc8dp7fw'] =
                                                    debugSerializeParam(
                                                  rowTrainerProfileResponse
                                                      .statusCode,
                                                  ParamType.int,
                                                  link:
                                                      'https://app.flutterflow.io/project/neva-sport-firebase-m5k9cq?tab=uiBuilder&page=Chats',
                                                ...
                                                _model.debugBackendQueries[
                                                        'TrainerProfileCall_responseBody_Row_gc8dp7fw'] =
                                                    debugSerializeParam(
                                                  rowTrainerProfileResponse
                                                      .bodyText,
                                                  ParamType.String,
                                                              ...
                                                              child: Text(
                                                                ...
                                                                style: FlutterFlowTheme.of(
                                                                    ...
                                                                    .override(
                                                                      fontFamily:
                                                                          'Montserrat',
                                                                      color: containerVarItem.lastMessageSeenBy.contains(FFAppState().profiledata.id) ==
                                                                              false
                                                                          ? FlutterFlowTheme.of(context)
                                                                              .secondary
                                                                          : FlutterFlowTheme.of(context)
